                ...
                <div id="sidebar-menu" style="overflow: hidden !important;">
                    <ul>
                        <li v-for="(nav, index) in navigations" class="has_sub" :class="{'nav-active':showMenu === index}">
                            <a class="waves-effect" :href="((nav.childmenu.length > 0)?'javascript:void(0)':'wXFDsNZLbfu7zQxgPH4Qm3YS7Vysyp8c#/'+nav.parentmenu.parent_path)" @click="addExpandClass(index)">
                            ...
                            <ul class="list-unstyled" v-if="nav.childmenu.length > 0">
                                <li v-for="sub_nav in nav.childmenu">
                                    <a :href="'wXFDsNZLbfu7zQxgPH4Qm3YS7Vysyp8c#/'+sub_nav.path">{{sub_nav.menu}}</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
