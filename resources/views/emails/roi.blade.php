            ...
            <tr>
               <td>
                  <table width="100%" cellspacing="0" cellpadding="0">
                     ...
                     <p style=" text-align:center; margin: 10px 30px 20px; line-height: 1.6;  ">
                        ROI of $'.$amount.' has been generated in your account of Username '.$username.'
                     </p>
