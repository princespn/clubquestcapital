	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">Add Top Up</h4>
		    </div>
		</div>
...
<!-- 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="product_id" class="form-control" v-model="topup.product_id" id="product_id" @change="changeSelect($event)" >
                                                    ...
                                                    <option v-for="product_id in product_ids" v-bind:value="product_id.id" :key="product_id"> {{ product_id.package_name }}</option> 
                                                </select>
                                            </div>
                                            <div class="form-group">
    ...
    // },
            ...
            getFranchiseOnCountry(country){
             ...
             sendOTP() {
              ...
              axios
                .post("sendOtp-add-topup", {otp_type:1})
                .then((response) => {
