                ...
                <div class="panel panel-primary">
                    <div class="panel-body">
                           ...
                           <div class="form-label-group">
                                   Note:- Password must be more than 8 characters. It should contain uppercase, lowercase, numerical and special characters.              
                                    </div> 
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label> User Id </label>
                                                 <input type="text" id="user_id" name="user_id" placeholder="Enter User Id" v-model="user_id" class="{ error: errors.has('user_id') } form-control" v-validate="'required|min:5|max:22'" v-on:input="checkuserexist">
                                                 <div v-if="useractive" class="tooltip2"> <span class="text-danger error-msg-size tooltip-inner">
                                                    {{ this.usermsg }}</span>
                                                    </div>    
                                                 <!---<div v-if="usermsg" class="tooltip2" v-show="errors.has('user_id')">
                                            ...
                                            <div class="form-group" style="position: relative;">
                                                <label> New Password </label>
                                                 <input type="password" id="password" name="password" placeholder="Enter New password" v-model="password" class="{ error: errors.has('password') } form-control" maxlength="30" minlength="8" v-validate="'required|min:8|max:30'">
                                            ...
                                            <div class="form-group" style="position: relative;">
                                                <label>Re-Type Password</label>
                                                  <input type="password" id="re_type_password" name="re_type_password" placeholder="Enter Re-Type Password" v-model="re_type_password" class="{ error: errors.has('re_type_password') } form-control"  maxlength="30" minlength="8" v-validate="'required|min:8|max:30'" v-on:keyup="matchpassword">
