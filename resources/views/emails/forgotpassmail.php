        ...
        <table style="width: 600px;background: url(.$bg.);background-size: cover;color: #707070; background-position: right top;margin: auto; border-spacing: 0;text-align: center;    border: 1px solid #9c9c9c;box-shadow: 0px 0px 10px #6f6f6f;">
          ...
          <tr>
            <td style="margin: 70px 0 20px 0;display: block;">
              <b>Did you try to change the Password of your account? <br> If Yes, use the below code to proceed. </b>
            </td>
          </tr>
          <tr>
            <td>
              <p style="background: transparent linear-gradient(358deg, #005CDA 0%, #BBDBFC 100%) 0% 0% no-repeat padding-box;border-radius: 11px;width: 400px;color: #fff; font-weight: 600; padding: 10px 0px;box-shadow: 0px 0px 5px #4116df;text-decoration: none;display: block;max-width: 230px;    margin: 10px auto 20px auto;"> ' . $code .' </p>
            </td>
          </tr>
          <tr>
            <td>
