                                   ...
                                   Note:- Password must be more than 6 characters. It should contain uppercase, lowercase, numerical and special characters.              
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-12">
                                                <div class="form-label-group">
			                                             		<input name="old_password" class="form-control" placeholder="Enter Your Old Password" id="old_password" type="password" v-model="updatepassword.old_password" data-vv-as="old password">
                                            ...
                                            <div class="col-md-4 col-12">
                                                <div class="form-label-group">
                                                    	<input ref="new_password" name="new_password" class="form-control" placeholder="Enter Your New Password" id="new_password" type="password" v-model="updatepassword.new_password" v-validate="'required|min:8|max:30'" maxlength="30" data-vv-as="new password">
                                            ...
                                            <div class="col-md-4 col-12">
                                                <div class="form-label-group">
                                                   <input name="retype_password" class="form-control" placeholder="Re-Type New Password" id="retype_password" type="password" v-model="updatepassword.retype_password"  v-validate="'required|min:8|max:30'" maxlength="30" data-vv-as="re-enter password" v-on:keyup="matchpassword()">
