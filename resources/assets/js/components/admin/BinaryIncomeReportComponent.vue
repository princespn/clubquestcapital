		    ...
		    <div class="container">
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        <table id="binary-income-report" class="table table-striped table-bordered dt-responsive">
		                            <thead>
		                                <tr>
		                                    <th>Sr.No</th>
		                                    <th>User Id</th>
    ...
    export default {
        ...
        methods: {
            ...
            productReport(){
                ...
                setTimeout(function(){
                    const table = $('#binary-income-report').DataTable({
                        ...
                        ajax: {
                            url: apiAdminHost+'/getbinaryincome',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
            ...
            exportToExcel(){
                ...
                axios.post('getbinaryincome', params).then(resp => {
                    if(resp.data.code === 200){                    
