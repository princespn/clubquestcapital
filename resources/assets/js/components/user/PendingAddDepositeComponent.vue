				  ...
				  <div class="card">
				   <div class="card-body user-detail">
				     <ul class="nav nav-pills">
					  <li class="active">
                        <router-link to="/add-fund-one" >Add Funds</router-link></li>
                        <li><router-link to="/pending-add-deposite"   class="active">Pending Funds transactions</router-link></li>
					  ...
					  <div class="col-md-12">
					     <div class="table-wraper report-table-section">
					      <div class="table-responsive">
						    <table id="pending-deposite" class="report-table table depos-table table-striped table-sm" style="width:100%">
								<thead>
									<tr>
										...
										<th><span class="th-wraper">Payment Mode</span></th>
