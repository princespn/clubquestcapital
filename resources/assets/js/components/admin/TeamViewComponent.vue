		                               ...
		                               <!--  <div class="col-md-3"></div> -->
		                                ...
		                                <div class="col-md-2">
		                                    <div class="form-group">
		                                        ...
		                                        <input class="form-control" placeholder="Enter Sponsor id" type="text" id="leader_id" f>
		                                    </div>
		                                </div>
                ...
                setTimeout(function(){
                    const table = $('#team-view-report').DataTable({
                        ...
                        columns: [
							...
							{
                                render: function (data, type, row, meta) {
                                    if (row.joining_date === null || row.joining_date === undefined || row.joining_date === '') {
                                      return `-`;
                                    } else {
