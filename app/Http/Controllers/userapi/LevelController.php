...
class LevelController extends Controller {
	...
	public function getLevelsViewTreeManualProductBase(Request $request) {
		...
		if (isset($arrInput['id']) && !empty($arrInput['id']) && Auth::user()->user_id != $arrInput['id']) {
			$checkUser = User::select('tbl_users.id')->join('tbl_today_details as ttd', 'ttd.from_user_id', '=', 'tbl_users.id')->where(['tbl_users.user_id' => $arrInput['id']])->first();
