   ...
   <div class="container-fluid">
      <div class="row page-titles">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="javascript:void(0)">Activation</a>
            </li>
         </ol>
      </div>
      <!-- row -->
                                 ...
                                 <div class="row">
                                    <div class="col-md-3">
                                       <div class="reward-income-bg-amt">
                                          ...
                                          <img src="public/user_files/assets/images/wallet-new.png" class="img-fluid w160">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                       <div class="row rmb">
                                          <div class="col-md-6" style="display:none;">
                                             <div class="form-group">
                                                <label class="control-label">Enter User</label> <br> <input formcontrolname="touser-id" id="touser-id" name="touser-id" placeholder="Enter User Id" v-model="username" @change="checkUserExisted" data-vv-as="User ID" v-validate="'required'" readonly type="text" class="form-control"> 
                                          ...
                                          <div class="col-md-6">
                                           ...
                                           <div class="col-md-6" v-if="show_wallet == 1">
                                              <div class="mb-2">
                                                ...
                                                <div>
                                                  <input name="transcation_type" type="radio" id="radio_9" class="radio-col-primary"  v-model="transcation_type" value="2"/>
                                       ...
                                       <div class="panel-footer bg-gray text-center">
                                          <div class="col-lg-12">
                                            <br> <button type="button" @click="updateSelfTopup()" :disabled="!iscomplete||usermsg!=''" id="topupsub" class="btn btn-primary">Submit</button>
                                            </div>
                                       </div>
                                    </div>
                                 </div>
    ...
    getUserDetails() {
       axios
         ...
         .then(response => {
           ...
           this.username = response.data.data.user_id;
