                           ...
                           <div class="col-xl-12">
                              <div class="auth-form">
                                 <div class="text-center mb-3">
                                    <a href="https://www.xentocorp.com/" target="_blank">
                                 ...
                                 <form @submit.prevent="registerUser" data-vv-scope="registerform" autocomplete="off">
                                    <div class="row">
                                       <!-- <div class="mb-3 col-md-6">
                                          <input type="text" name="user_id" placeholder="XP000001" v-model="register.user_id" v-validate="'required|alpha_num|min:5|max:30'" data-vv-as="user_id" readonly="" class="form-control">
                                       ...
                                       <div class="mb-3 col-md-6 mynum">
                                          <vue-tel-input  type="number" name="mobile" @onInput="onInput" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57" defaultCountry="VG" placeholder="Mobile Number" v-model="register.mobile" v-validate="'required|max:22|min:6'"></vue-tel-input>
                                    ...
                                    <div class="row justify-content-center mt-2 mb-2">
                                       ...
                                       <div class="col-md-5 text-center mt-4">
                                          <button class="btn btn-primary btn-block logbtn" value="Register" :disabled=" !isCompleteRegister || isActiveBtn == false" type="submit">Sign me up</button>
