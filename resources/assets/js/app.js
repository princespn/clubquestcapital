...
let result = flights.filter(flight => flight.IATA  == value); 
   ...
   return `https://xento-corp.s3.ap-south-1.amazonaws.com/flight-logo/a8YUYJymRQ0VwEtwYxbIUcMRBQ37u74K82rKoXUw.png`;


})

if (window.location.href.indexOf("wXFDsNZLbfu7zQxgPH4Qm3YS7Vysyp8c#") > -1) {
