                                    ...
                                    <form id="change-user-password">
                            			...
                            			<div class="col-md-5 col-md-offset-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="new_password" class="form-control" maxlength="30"  minlength="8" placeholder="Enter Your New Password"  type="password" v-model="changepwd.new_password" v-validate="'required|max:30|min:8'">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="retype_password" maxlength="30"  minlength="8" class="form-control { error: errors.has('retype_password') }" formcontrolname="retype_password" placeholder="Re-Type New Password" id="retype_password" type="password" v-model="changepwd.retype_password"  v-validate="'required|max:30|min:8'">
