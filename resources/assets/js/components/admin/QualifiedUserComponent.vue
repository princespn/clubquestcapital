	...
	<div class="content">
		<div class="">
		    <div class="page-header-title">
		        <h4 class="page-title">Qualified Users Report</h4>
		    </div>
		</div>
		    ...
		    <div class="container">
		                            ...
		                            <div class="">
		                                ...
		                                <div class="col-md-2">
		                                    <div class="form-group">
		                                        ...
		                                        <input class="form-control" required="" placeholder="Enter Sponsor Id" type="text" id="sponser_user_id">
		                                    </div>
		                                </div>
		                                <div class="row">
		                                    <div class="col-md-12">
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="panel panel-primary">
		                    <div class="panel-body">
		                        <table id="qualified-user-report" class="table table-striped table-bordered dt-responsive">
		                            <thead>
		                                <tr>
		                                    <th>Sr.No</th>
		                                    <th>User Id</th>
    ...
    export default {
        ...
        methods: {
        	dateFormat(date) {
             ...
             exportToExcel(){
                var params = {frm_date: $('#frm_date').val(), to_date: $('#to_date').val(),user_id: $('#user_id').val(),sponser_id : $('#sponser_user_id').val(),action:'export',responseType: 'blob' };
                axios.post('getqualifieduser', params).then(resp => {
                    if(resp.data.code === 200){
                        ...
                        fileLink.setAttribute('download', 'QualifiedUser.xls');
            ...
            qualifiedUsersReport(){
                ...
                setTimeout(function(){
                    const table = $('#qualified-user-report').DataTable({
                        ...
                        ajax: {
                            url: apiAdminHost+'/getqualifieduser',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
                                ...
                                let params = {
                                    ...
                                    to_date: $('#to_date').val(),
                                   	user_id : $('#user_id').val(),
                                   	sponser_id : $('#sponser_user_id').val() 
                                };
